...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('compte') }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('put')
            ...
            <div class="card ">
              <div class="card-header card-header-primary">
                ...
                <p class="card-category">{{ __('Informations De compte') }}</p>
              </div>
              <div class="card-body ">
                @if (session('status'))
                  <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('phone') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" id="input-phone" type="tel" placeholder="{{ __('Téléphone') }}" value="{{ old('phone', auth()->user()->phone) }}" required="true" aria-required="true"/>
                      @if ($errors->has('phone'))
      ...
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('compte') }}" class="form-horizontal">
            @csrf
            @method('put')
