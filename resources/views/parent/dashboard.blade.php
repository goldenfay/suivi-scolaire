        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-info card-header-icon">
              ...
              <p class="card-category">Formations achetées</p>
              ...
              <div class="col-sm-6">
                ...
                <div class="card-header">
                  <div class="container">
                    <div class="row">
                      <div class="col-md-6">
                      <img src="{{__($child->eleve->Pic_Path!=null?$child->eleve->Pic_Path: asset('assets')."/autres/default-eleve-avatar-male.jpg" )}}" 
