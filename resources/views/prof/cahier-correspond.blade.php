              ...
              <input type="hidden"  value="{{$user->prof->Id}}" name="profId"/>
                <div class="form-row my-3">
                  ...
                  <div class="form-group col-md-6 col-sm-12">
                    ...
                    <input type="text" class="form-control" name="libelle" id="libelle-input" placeholder="Titre de la communication ...">
                ...
                <div class="form-group my-3">
                  ...
                  <textarea type="text" class="form-control" name="corps" id="contenu-input" placeholder="Spécifiez le corps de votre correspondance ..." ></textarea>
                  @if ($errors->has('corps'))
