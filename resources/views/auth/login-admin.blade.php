@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('Connexion Admin')])
...
<div class="container" style="height: auto;">
  <div class="row align-items-center">
    ...
    <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
      <form method="POST" action='{{ url("login/admin") }}' aria-label="{{ __('Connexion') }}">
        @csrf

        <div class="card card-login card-hidden mb-3">
          <div class="card-header card-header-warning text-center">
           
            <h4 class="card-title"><strong>{{ __('Authentification Admin') }}</strong></h4>
